...
public class CheckPhotoResultsHeader extends TopLevelObj {

    @SerializedName("data")
    private CheckPhotoResults data;

    public CheckPhotoResults getData() {
        return data;
    }

    public void setData(CheckPhotoResults data) {
        this.data = data;
    }

    public static class CheckPhotoResults {
        /**
